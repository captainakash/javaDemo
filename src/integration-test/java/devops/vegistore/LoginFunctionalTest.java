...
import devops.vegistore.IntegrationTest;
...
public class LoginFunctionalTest {
	...
	public void loginSuccess() {
        driver.get("http://localhost:6080/vegistore");
	...
	public void registrationSuccess() {
        driver.get("http://localhost:6080/vegistore/register.jsp");
        ...
        button.click();
        assertTrue(driver.getPageSource().contains("vegistore"));
	}
	
	@Test
	public void forgotPasswordSuccess() {
        driver.get("http://localhost:6080/vegistore/forgotpassword.jsp");      
